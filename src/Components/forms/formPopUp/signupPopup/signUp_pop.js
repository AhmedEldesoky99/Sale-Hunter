...
class SignUpPopUp extends Component {
    ...
    handleRegister = (e) => {
        ...
        if (this.checkBtn.context._errors.length === 0) {
            ...
            dispatch(register(this.state.name, this.state.email, this.state.password, this.state.confirmPassword, this.state.profile_img))
    ...
    render(){
        ...
        return(
            <div className={`sign-up-popup ${dark ? "dark" : ""}`} hidden>
                ...
                <div className="ui dimmer modals visible active" onClick = {this.close_popup}></div>
                <div className="popup-box">
                    <div className="popup-form">

                        <div className="close-popup" onClick = {this.close_popup}>&times;</div>
                        <Form
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="password-input">
                                    <div className="form-element">
                                        ...
                                        />
                                        <div className={`password-toggler ${ar? 'ar' :''}`} onClick = {() => this.setState({isVisable: !this.state.isVisable})}>
                                ...
                                <div className="password-input">
                                    <div className="form-element">
                                        ...
                                        />
                                        <div className={`password-toggler ${ar? 'ar' :''}`} onClick = {() => this.setState({confirmVisible: !this.state.confirmVisible})}>
                            ...
                            <div className="checker">
                                <div className="form-check mb-3">
                                    <label className={`form-check-label ${ar? 'ar' :''}`} htmlFor="validationFormCheck2">
                                        <Input 
                                            type="checkbox" 
                                    ...
                                    <span className="forgot-signUp">
                                        <Link to="/forgot" className={`link-route ${ar? 'ar' :''}`}>
                            ...
                            <div className="submitting ">
                                <div className="form-floating">
                                    <input type="submit"className={`form-control ${ar? 'ar t-center' :''}`} 
                            ...
                            />
                            <a id="profileBtn1" href="/profile" style={{ display: "none" }}> </a>
                            <SignWith 
                                type ='sign-in' 
                                oppsite='sign-up'
                            ...
                            <h4 className={`sign-in-route ${ar? 'ar t-center' :''}`}>
                                ...
                                <span className={ar? 'ar' :''} onClick = {this.showSignIn}>{ar? '    تسجبل الدخول' : 'Sign in'}</span>
                            </h4>
                            </div>
                        </Form>
                    </div>
