                ...
                <div className="search-results">
                  ...
                  <div className="result-section">
                    ...
                    {offline.length === 0 && (
                      <div className={`no-result ${ar ? "ar" : ""}`}>
                        {ar
                          ? `لا يوجد منتجات محلية بأسم ${this.searchTerm}`
                          : `There is no offline products called ${this.searchTerm} `}
                      </div>
                    )}
                    {offline.length > 0 && (
                  ...
                  <div className="result-section">
                    ...
                    {online.length === 0 && (
                      <div className={`no-result ${ar ? "ar" : ""}`}>
                        {ar
                          ? `لا يوجد منتجات عبر الإنترنت بأسم ${this.searchTerm}`
                          : `There is no online products called ${this.searchTerm} `}
                      </div>
                    )}
                    {online.length > 0 && (
                      <Slider
